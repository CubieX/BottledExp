...
public class EventListener implements Listener 
{
   ...
   {      
      ...
      float delta = player.getTotalExperience() - BottledExp.levelToExp(player.getLevel());
      delta = delta / BottledExp.deltaLevelToExp(player.getLevel()) * BottledExp.deltaLevelToExp(newLevel);
